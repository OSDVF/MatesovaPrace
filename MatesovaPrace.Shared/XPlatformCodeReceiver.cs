...
namespace Google.Apis.Auth.OAuth2
{
    ...
    /// </summary>
    public class XPlatformCodeReceiver : ICodeReceiver
    {
        /// <summary>
        ...
        private static readonly ILogger Logger = ApplicationContext.Logger.ForType<XPlatformCodeReceiver>();
  ...
  <body>
    ...
    <script type='text/javascript'>
      ...
      //if (window.opener) { window.opener.checkToken(); }
        ...
        /// <summary>
        /// Create an instance of <see cref="XPlatformCodeReceiver"/>.
        /// </summary>
        public XPlatformCodeReceiver() : this(DefaultClosePageResponse, CallbackUriChooserStrategy.Default) { }

        /// <summary>
        /// Create an instance of <see cref="XPlatformCodeReceiver"/>.
        /// </summary>
        /// <param name="closePageResponse">Custom close page response for this instance</param>
        public XPlatformCodeReceiver(string closePageResponse) :
        ...
        public XPlatformCodeReceiver(string closePageResponse, CallbackUriChooserStrategy strategy)
        {
